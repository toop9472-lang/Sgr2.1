...
async def forgot_password(data: ForgotPasswordRequest):
    ...
    # Build reset URL
    frontend_url = "https://saqr-build-final.preview.emergentagent.com"
...
async def google_sign_in_redirect(redirect_uri: str = 'saqr://auth/callback'):
    ...
    google_auth_url = (
        ...
        f"?client_id={client_id}"
        f"&redirect_uri={os.environ.get('GOOGLE_REDIRECT_URI', 'https://saqr-build-final.preview.emergentagent.com/api/auth/google/callback')}"
        ...
        async with httpx.AsyncClient() as client:
            token_response = await client.post(
                ...
                data={
                    ...
                    'redirect_uri': os.environ.get('GOOGLE_REDIRECT_URI', 'https://saqr-build-final.preview.emergentagent.com/api/auth/google/callback')
                }
            )
