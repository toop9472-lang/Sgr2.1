        ...
        <div className="flex flex-col items-center gap-2 py-6">
          <div className="flex items-center gap-1.5">
            ...
            <p className={`text-[11px] font-medium ${isDark ? 'text-gray-600' : 'text-gray-500'}`}>
              {isRTL ? 'الإصدار 7.3.1' : 'Version 7.3.1'}
            </p>
            <div className={`w-1 h-1 rounded-full ${isDark ? 'bg-gray-700' : 'bg-gray-300'}`} />
          </div>
          ...
          <div
            data-testid="maroof-verification-badge"
            className={`mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border ${
              isDark
          ...
          >
            ...
            <span className={`text-[10px] font-semibold ${isDark ? 'text-emerald-300' : 'text-emerald-700'}`}>
              {isRTL
                ...
                : 'Verified by Ministry of Commerce · Reg: 0000294044'}
            </span>
          </div>
        </div>
      </div>
