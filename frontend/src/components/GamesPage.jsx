...
const GamesPage = ({ user, onNavigate, onPointsEarned }) => {
  ...
  const games = [
    { id: 'aiquest', name: 'AI Quest', colors: ['#ec4899', '#9333ea'], description: 'تحدى الذكاء الاصطناعي', maxPoints: 30, online: false, onlineCost: 0, category: 'ذكاء اصطناعي', badge: 'جديد', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/06c2b9af28e999d11dc9acb5d070338281a993c4674d4d7d0b6ab3e3924d1af0.png' },
    { id: 'chess', name: 'الشطرنج', colors: ['#7c3aed', '#4c1d95'], description: 'لعبة الملوك والاستراتيجية', maxPoints: 25, online: true, onlineCost: 30, category: 'استراتيجية', badge: 'مميز', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/0500bcacbed800176055c4bfd28202347eb75abe6213e15f19f8214fd6f6934d.png' },
    { id: 'tictactoe', name: 'اكس او', colors: ['#f97316', '#c2410c'], description: 'تحدى منافسك وفكر بذكاء', maxPoints: 20, online: true, onlineCost: 20, category: 'سريعة', badge: 'شعبي', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/33709ad279c09e5cbaf629cd65397cd2a03bdecb4a5f09b043937f27adce9655.png' },
    { id: 'memory', name: 'الذاكرة', colors: ['#14b8a6', '#0f766e'], description: 'اختبر ذاكرتك وركز', maxPoints: 18, online: false, onlineCost: 0, category: 'ذهنية', badge: '', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/d95bce93defbebf9a6d2636f84df8aeb947c97057c22f296d5ca555efcda590a.png' },
    { id: 'snake', name: 'الثعبان', colors: ['#22c55e', '#15803d'], description: 'اللعبة الكلاسيكية المحبوبة', maxPoints: 20, online: false, onlineCost: 0, category: 'كلاسيكية', badge: 'كلاسيك', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/8eef33008cf96dbd01341bd90a1df8c5494d684ed2338f0ec60cbfaea7916d94.png' },
    { id: 'trivia', name: 'اسئلة ثقافية', colors: ['#10b981', '#047857'], description: 'اختبر معلوماتك العامة', maxPoints: 25, online: true, onlineCost: 20, category: 'ثقافية', badge: '250+ سؤال', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/2e924ada5224a07199229ac54b22bc84571b59dd3494a46bdf0fb78324571ebe.png' },
    { id: 'puzzle', name: 'تركيب الصور', colors: ['#3b82f6', '#1e40af'], description: 'رتب القطع لتكمل الصورة', maxPoints: 20, online: true, onlineCost: 25, category: 'ذهنية', badge: '', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/bd130ce79e7d79d40534d82131b67692c7a04e98d0df4b307a820569e59db691.png' },
    { id: 'riddles', name: 'الالغاز', colors: ['#eab308', '#ca8a04'], description: 'حل الالغاز الذكية', maxPoints: 20, online: false, onlineCost: 0, category: 'ذهنية', badge: '', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/6061e4d9950403e2f315a7c6107f5d29edc233cdaf36be8b85729592b42204fa.png' },
    { id: 'brickbreaker', name: 'تكسير الطوب', colors: ['#ec4899', '#be185d'], description: 'كسر كل الطوب واربح', maxPoints: 20, online: false, onlineCost: 0, category: 'اركيد', badge: '', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/2c127006856812b413c3027b7f9ba09fd5e94799f03b1e60073bd5ac01db192e.png' },
    { id: 'speedmath', name: 'سباق الحساب', colors: ['#8b5cf6', '#6d28d9'], description: 'حل المعادلات بسرعة', maxPoints: 22, online: true, onlineCost: 20, category: 'رياضيات', badge: 'تحدي', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/fb08724fcfd075f573cb6caa85234087c2f60b88557963d258dde0df765d428e.png' },
    { id: 'wordchain', name: 'سباق الكلمات', colors: ['#06b6d4', '#0891b2'], description: 'اكتشف الكلمات المخفية', maxPoints: 22, online: true, onlineCost: 25, category: 'لغوية', badge: '', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/2fc4dbd204a4ac22336dd2ff47174c2615ad00a97496165b44ede71820f884e3.png' },
    { id: 'colorswitch', name: 'تبديل الالوان', colors: ['#f43f5e', '#e11d48'], description: 'سرعة التفاعل مع الالوان', maxPoints: 18, online: false, onlineCost: 0, category: 'سريعة', badge: '', image: 'https://static.prod-images.emergentagent.com/jobs/3943d011-4c0b-4252-9b99-046dc8c507ce/images/3a0211bd8e37c202ba475214f6cd4a78086e29615fbe36f18fa7b822d0ec5faf.png' },
  ];
