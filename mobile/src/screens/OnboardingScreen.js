...
const ONBOARDING_SLIDES = [
  ...
  },
  {
    id: '3',
    title: 'ريلز المجتمع',
    description: 'شاهد وشارك مقاطع قصيرة 15 ثانية\nتابع صناع المحتوى وتفاعل معهم',
    icon: 'film',
    colors: ['#1e3a5f', '#0a1929'],
  },
  {
    id: '4',
    title: 'ادعُ أصدقاءك',
    description: 'احصل على 100 جوهرة صقر لكل صديق يسجل!\nشارك رابط الدعوة الآن',
    icon: 'people',
    colors: ['#1e3a5f', '#0a1929'],
  },
];
